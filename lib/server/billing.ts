...
export function planForProduct(productId: string | null | undefined): BillingPlan | null { if (!productId) return null; return (Object.keys(planCatalog) as BillingPlan[]).find((plan) => process.env[planCatalog[plan].productEnv] === productId) || null; }
