...
const voiceBenefit = { title: "🎤 Tap to Speak. No Need to Type.", description: "Simply tap the microphone, describe the patient's condition, and ShiftNote generates professional documentation in seconds." } as const;
const plans = [
